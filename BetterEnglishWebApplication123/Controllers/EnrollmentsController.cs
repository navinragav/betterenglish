...
namespace BetterEnglishWebApplication123.Controllers
{
    public class EnrollmentsController : Controller
    {
        ...
        {
            ViewBag.CourseID = new SelectList(db.Courses, "CourseID", "cardNo");
        ...
        public ActionResult Create([Bind(Include = "EnrollmentID,CourseID,StudentID,Grade")] Enrollment enrollment)
        {
            ...
            ViewBag.CourseID = new SelectList(db.Courses, "CourseID", "cardNo", enrollment.Course.CourseID);
            ViewBag.StudentID = new SelectList(db.Students, "StudentID", "FirstName", enrollment.Student.StudentID);
            return View(enrollment);
        }
